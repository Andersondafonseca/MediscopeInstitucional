...
export const scenes: JourneyScene[] = [
  ...
  },
  {
    ...
    kicker: 'O verdadeiro poder do Mediscope aparece quando os dados começam a trabalhar pela gestão.',
    body: 'Toda instituição de saúde produz milhares de informações todos os dias. Atendimentos, exames, medicamentos, equipamentos, escalas, faturamento, indicadores assistenciais, custos e produtividade.',
    metric: '14+',
    metricLabel: 'motores especializados de Inteligência Artificial',
    icon: MonitorCog,
    accent: 'blue',
    points: [
      'O desafio nunca foi gerar dados.',
      'O desafio sempre foi transformá-los em decisões.',
      'Mais do que controlar processos, o Mediscope ajuda a construir uma gestão mais eficiente, sustentável e orientada por resultados.',
    ],
    introParagraphs: [
      'Decisão em Tempo Real|O Mediscope conecta toda a operação em uma única plataforma inteligente, permitindo que hospitais e gestores públicos acompanhem o desempenho da instituição praticamente em tempo real, identifiquem oportunidades de melhoria, reduzam desperdícios e tomem decisões baseadas em evidências.',
      'Secretarias Municipais de Saúde|Monitoramento da rede em tempo praticamente real; Indicadores estratégicos; Vigilância epidemiológica; Atenção Primária; Regulação; Farmácia; Cobertura territorial; Planejamento de políticas públicas',
      'Hospitais|Ocupação hospitalar; Giro de leitos; Centro cirúrgico; Faturamento; Custos; Estoques; Farmácia; Recursos humanos; Indicadores assistenciais',
      'Inteligência Financeira|Cada atendimento gera conhecimento.|O Mediscope acompanha continuamente receitas, custos, margens, produtividade, utilização de recursos e desempenho operacional.|Gestores deixam de depender de planilhas isoladas e fechamentos mensais para compreender a realidade da instituição.|As informações permanecem disponíveis continuamente para apoiar decisões rápidas e reduzir desperdícios.',
      'Inteligência Operacional|O Mediscope permite analisar qualquer recurso da instituição.|Equipamentos; Departamentos; Profissionais; Especialidades; Unidades|Cada recurso pode ser acompanhado individualmente, considerando produtividade, utilização, custos operacionais, consumo de insumos, manutenção, disponibilidade, receita gerada, margem operacional e retorno sobre investimento.|Mais do que saber quanto um equipamento custa, o gestor passa a entender quanto valor ele produz para a instituição.',
      'Inteligência Artificial para Gestão|Mais de 14 motores especializados de Inteligência Artificial trabalham continuamente sobre os dados da plataforma.|Eles identificam padrões, acompanham indicadores, analisam tendências, detectam anomalias e produzem recomendações para diferentes áreas da gestão.|Enquanto equipes trabalham na operação diária, o Mediscope continua aprendendo, correlacionando informações e gerando novos insights estratégicos.',
      'Gestão em Tempo Real|O hospital muda a cada segundo.|Sua gestão também deveria.|O Mediscope transforma eventos operacionais em indicadores atualizados continuamente, permitindo acompanhar faturamento, produção, produtividade, utilização de recursos, custos e desempenho conforme a instituição funciona.|Menos tempo esperando relatórios. Mais tempo tomando decisões.',
    ],
    closing: [
      'A tecnologia registra informações. A inteligência transforma informações em decisões. O Mediscope foi criado para entregar ambas.',
      'Medicina Baseada em Evidências; Dados Integrados; Inteligência Artificial; Gestão Baseada em Evidências',
    ],
  },
  {
    id: 'cta',
    nav: 'Vamos conversar',
    eyebrow: 'Contato',
    title: 'Vamos construir o futuro da saúde juntos.',
    body: 'O Mediscope foi desenvolvido para hospitais, clínicas, operadoras, instituições privadas e gestores públicos que desejam elevar o nível da assistência, fortalecer a gestão e utilizar Inteligência Artificial de forma prática, segura e responsável.',
    metric: 'M',
    metricLabel: 'demonstração personalizada',
    icon: ShieldCheck,
    accent: 'green',
    points: [
      'Nossa equipe está preparada para compreender a realidade da sua instituição e apresentar uma demonstração personalizada da plataforma.',
    ],
  },
];
