...
const ACCESS_CODE = 'Afortunado';
const ACCESS_SESSION_KEY = 'mediscope-access-granted';
...
function AccessGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  return (
    <main className="grid min-h-screen place-items-center overflow-hidden bg-[#02070d] px-6 text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_24%,rgba(14,165,233,.2),transparent_34%),linear-gradient(180deg,rgba(2,7,13,.74),#02070d)]" />
      <form
      ...
      >
        ...
        <input
          ...
          className="mt-12 w-full rounded-[8px] border border-cyan-100/20 bg-white/[0.06] px-5 py-4 text-center text-base font-semibold text-white shadow-[0_24px_80px_rgba(0,0,0,.28)] outline-none transition placeholder:text-cyan-50/38 focus:border-cyan-200/70 focus:bg-white/[0.09] focus:shadow-[0_0_0_4px_rgba(103,232,249,.12)]"
        />
        <button
          type="submit"
          className="mt-5 w-full rounded-[8px] border border-cyan-200/40 bg-cyan-200 px-5 py-4 text-sm font-extrabold uppercase tracking-[0.18em] text-[#021018] shadow-[0_18px_44px_rgba(34,211,238,.2)] transition hover:bg-white focus:outline-none focus:ring-4 focus:ring-cyan-200/24"
        >
          Acessar
        </button>
        <p
          className={`mt-4 min-h-5 text-sm font-semibold text-red-200 transition ${
